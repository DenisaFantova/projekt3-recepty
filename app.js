...
5) Na recepty v seznamu by mělo jít kliknout a na pravé polovině, se objeví detail receptu.
    Doplň patričné údaje receptu do HTML prvků s ID:
    recept-foto,
    recept-kategorie,
    recept-hodnoceni,
    recept-nazev,
...
hledat.addEventListener('input', hledej); // při vstupu uživatele do vstupu se zavolá funkce vyhledávání v receptech
